...
namespace BitMEX
{
	...
	public class BitMEXApi
	{
		...
		public string LimitOrder(string Symbol, string Side, double Quantity, Double Price, string clOrdID, bool ReduceOnly = false, bool PostOnly = false, bool Hidden = false)
		{
			var param = new Dictionary<string, string>();
			param["symbol"] = Symbol;
			param["side"] = Side;
		...
		public string GetOrder(string orderID)
		{
			...
			string res = Query("GET", "/order", param, true);
				...
				res = Query("GET", "/order", param, true);

			return res;
		}

		public string AmendOrder(string orderID, double Price)
		{
			var param = new Dictionary<string, string>();
			param["orderID"] = orderID;
			...
			//res = Query("PUT", "/order", param, true);
		...
		/*
		internal void LimitOrder(string v1, string v2, double v3, int v4, bool v5, bool v6, bool v7)
		{
